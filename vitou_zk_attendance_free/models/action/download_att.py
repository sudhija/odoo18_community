...
class VitouzkDownloadAtt(models.TransientModel):
     _name = 'vitouzkf.download.att'
     _description = 'Download Staff Attendance'
               ...
               if conn_1:
                    ...
                    if attendance_1:
                         ...
                         for user_id, atten_times in attendance_dict.items():
                              ...
                              employee = self.env['hr.employee'].sudo().search([('zkuser_user_id', '=', user_id),('zk_isfixshift','=',True)],limit=1)
